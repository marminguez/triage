                            ...
                            <div className="space-y-2">
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input
                                        ...
                                        onChange={(e) => setFormData(prev => ({ ...prev, lives_alone: e.target.checked }))}
                                ...
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input
                                        ...
                                        onChange={(e) => setFormData(prev => ({ ...prev, mobility_limitations: e.target.checked }))}
                                        className="w-4 h-4 text-primary rounded border-gray-300" />
                                ...
                                <label className="flex items-center gap-2 cursor-pointer">
                                    <input
                                        ...
                                        onChange={(e) => setFormData(prev => ({ ...prev, cognitive_difficulty_flag: e.target.checked }))}
                                        className="w-4 h-4 text-primary rounded border-gray-300" />
